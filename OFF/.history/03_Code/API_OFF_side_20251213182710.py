...
def main():
    ...
    for t in np.arange(off_interface.off_sim.settings_sim['time start'],
        ...
        off_interface.off_sim.wind_farm.turbines[0].turbine_states.set_ct(0.2 + 0.1*np.sin(0.1*t))
        print(off_interface.off_sim.wind_farm.turbines[0].turbine_states.get_all_states()[0,:])
        ...
        print(off_interface.off_sim.wind_farm.turbines[0].turbine_states.get_all_states()[0,:])
        exit()
        off_interface.off_sim.wind_farm.turbines[0].turbine_states.set_ct(0.3)
        print(off_interface.off_sim.wind_farm.turbines[0].turbine_states.get_all_ct())
        exit()
