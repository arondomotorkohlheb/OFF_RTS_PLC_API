...
class TurbineStatesMask(TurbineStates):
    ...
    def get_cp(self, index: int) -> float:
        """
...
class TurbineMask(Turbine):
    ...
    def calc_power(self, wind_speed, air_den, air_direction):
        return self.turbine_states.get_cp() * 0.5 * np.pi * (self.diameter / 2) ** 2 * wind_speed ** 3 * air_den \
