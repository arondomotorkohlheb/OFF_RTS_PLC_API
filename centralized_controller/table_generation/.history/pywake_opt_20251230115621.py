...
if __name__ == "__main__": 
    ...
    ws_array = np.array([0, 4, 6, 8, 10, 12, 15, 25])
    power = np.array([0, 0, 0.6, 1.4, 2.2, 3.0, 3.0, 0]) * 1e6  # W
    ct = np.array([0, 0.74, 0.74,0.74, 0.74, 0.74, 0.74, 0])
    ws_array = np.array([ws])
    power = np.array([0.5*0.47*ws**3*setup["A"]*1.225])/1e6 # in MW
    ct = np.array([0.74])
