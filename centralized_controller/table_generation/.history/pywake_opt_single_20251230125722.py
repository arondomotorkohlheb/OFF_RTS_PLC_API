...
def init_pywake():
    ...
    return site, windTurbines, layout_x, layout_y, setup


def optimize_yaw_angles(ws, wd, ti = 0.01):

    site, windTurbines, layout_x, layout_y, setup = init_pywake()
    ...
    for tur_ind in opt_order:
        ...
        best_yaw_i = 0
        # print(f'for turbine {tur_ind} Initial power with 0 yaw: {best_power} MW')
        
        while relative_power_improvement > 0.01 / 100:
