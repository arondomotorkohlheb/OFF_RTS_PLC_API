...
def optimize_yaw_angles(ws, wd, set_up_constants, ti = 0.01, n_points_per_range = 4, search_radius = 20, improvement_margin = 0.01/100):
...
if __name__ == "__main__":
    ...
    set_up_constants windTurbines, layout_x, layout_y, setup = init_pywake()
    set_up_constants = (windTurbines, layout_x, layout_y, setup)
    best_power, yaw = optimize_yaw_angles(ws=8, wd=200, windTurbines=windTurbines, layout_x=layout_x, layout_y=layout_y, setup=setup)
