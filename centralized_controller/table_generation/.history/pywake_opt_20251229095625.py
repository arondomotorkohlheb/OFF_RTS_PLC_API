...
if __name__ == "__main__": 
    ...
    # Load wind farm layout from YAML file
    yaml_data = load_windfarm_yaml("hornsrev1.yaml")
    layout_x = np.array(yaml_data["wind_turbines"]["x"])
    layout_y = np.array(yaml_data["wind_turbines"]["y"])
