...
from py_wake.deficit_models.gaussian import BastankhahGaussian, NiayifarGaussianDeficit
...
if __name__ == "__main__": 
    ...
    wfm = BastankhahGaussian(site, windTurbines, deflectionModel=NiayifarGaussianDeficit)

    #here we import the turbine, site and wake deficit model to use.
    yaws = [80 for _ in range(10)]  # example yaw angles for each turbine in degrees
