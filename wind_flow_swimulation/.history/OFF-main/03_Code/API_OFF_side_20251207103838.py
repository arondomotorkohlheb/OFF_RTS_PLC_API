...
def main():
    ...
    for t in np.arange(off_interface.off_sim.settings_sim['time start'],
        ...
        wind_velocity, turbulence_intensity = off_interface.off_sim.run_one_step(t)
        print(f"Time: {t}, Wind Velocity at first turbine: {wind_velocity[0]}, Turbulence Intensity at first turbine: {turbulence_intensity[0]}")
