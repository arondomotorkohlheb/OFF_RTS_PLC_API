...
class TWFSolver(WakeSolver):
    ...
    def _get_wind_speeds_rp_reduced(self, wind_farm: wfm.WindFarm) -> tuple:
        ...
        for i_t in range(wind_farm.nT):
            turbine_states.append(wind_farm.turbines[i_t].turbine_states.create_interpolated_state(0, 1, 0, 1))
            ambient_states.append(wind_farm.turbines[i_t].ambient_states.create_interpolated_state(0, 1, 0, 1))
