...
class OFF:
    ...
    def run_one_step(self, t):
        ...
        uv_r, turbulance_intensity = self.wake_solver.get_measurements_reduced(self.wind_farm)
        ...
        for idx, tur in enumerate(self.wind_farm.turbines):
            ...
            # this step includes all the important calculations
        ...
        self.ambient_corrector.update(t) # check this
        for idx, tur in enumerate(self.wind_farm.turbines):
        ...
        return uv_r, turbulance_intensity
