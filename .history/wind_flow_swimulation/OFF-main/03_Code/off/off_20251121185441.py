...
class OFF:
    ...
    def run_one_step(self, t):
        ...
        for idx, tur in enumerate(self.wind_farm.turbines):
            ...
            uv_r[idx, :], uv_op = self.wake_solver.get_wind_speeds_rp_reduced(idx, self.wind_farm)
            uv_op = self.wake_solver.get_wind_speeds_rp_reduced(idx, self.wind_farm)
            print(uv_r, len(uv_op))
            exit()
