...
class FlorisModel(LoggingManager):
    ...
    def _reinitialize(
        ...
        thrust_coefficients: list[float] | NDArrayFloat | None = None,
    ):
        """
        ...
        if thrust_coefficients is not None:
            self.core.set_thrust_coefficients(thrust_coefficients)
    ...
    def set(
        ...
        self.core.set_thrust_coefficients(thrust_coefficients)
        print("ct set for fmodel ", self.core.thrust_coefficients)
        ...
        print(self.core.thrust_coefficients)
        print(elf.core.thrust_coefficients)
    ...
    def get_turbine_thrust_coefficients(self) -> NDArrayFloat:
        if self._thrust_coefficients is not None:
            return self._thrust_coefficients
        else:
