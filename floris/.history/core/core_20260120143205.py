...
class Core(BaseClass):
    ...
    """
    thrust_coefficients = attr.ib(init=False)
    ...
    def __attrs_post_init__(self) -> None:
        ...
        self.thrust_coefficients = None # adding thrust coef attribute to carry this information to replace the ct computation
    ...
    def set_thrust_coefficients(self, thrust_coefficients):
        self.thrust_coefficients = thrust_coefficients
