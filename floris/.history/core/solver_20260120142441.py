...
def sequential_solver(
    ...
    thrust_coefficients: NDArrayFloat
) -> None:
    # Algorithm
    ...
    for i in range(grid.n_turbines):
        ...
        # replace this with passing ct from layer above
        ct_i = thrust_coefficients
...
def full_flow_sequential_solver(
    ...
    print("full flow seq solver called")
