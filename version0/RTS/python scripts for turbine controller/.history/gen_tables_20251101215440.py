...
# np.save('cp_table.npy', cp)
# np.save('ct_table.npy', ct)
# np.save('ctau_table.npy', ctau)

np.save('lambdas.npy', lambdas, allow_pickle=True)
np.save('betas.npy', betas, allow_pickle=True)
np.save('cp_table.npy', cp, allow_pickle=True)
np.save('ct_table.npy', ct, allow_pickle=True)
np.save('ctau_table.npy', ctau, allow_pickle=True)