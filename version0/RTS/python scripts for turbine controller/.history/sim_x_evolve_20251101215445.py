...
ctau = np.load('ctau_table.npy') allow_pickle=True)  # Allow loading of object arrays
betas = np.load('betas.npy', allow_pickle=True)
lambdas = np.load('lambdas.npy', allow_pickle=True)
