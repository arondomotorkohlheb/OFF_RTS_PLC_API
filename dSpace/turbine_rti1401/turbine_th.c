/************************ dSPACE target specific file *************************
   ...
   Include file .\turbine_rti1401\turbine_th.c :

   Task Configuration file for model : turbine

   RTI1401 7.11 (02-Nov-2018)/2.17
   13-Jan-2026 14:09:22
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\turbine_rti1401\turbine_th.c is for ST).
# endif
