/************************ dSPACE target specific file *************************
   ...
   Include file .\turbine2_rti1401\turbine2_th.c :

   Task Configuration file for model : turbine2

   RTI1401 7.11 (02-Nov-2018)/2.17
   13-Jan-2026 16:04:34

   MATLAB 9.5.0.1586782 (R2018b) Update 8
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\turbine2_rti1401\turbine2_th.c is for ST).
# endif
